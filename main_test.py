...
# Example usage
input_file_path = '/local/upb/users/u/uqudus/profiles/unix/cs/jaccord/VeracityCalculation/data/output_triples_IRIs2.jsonl'  # Replace with your input JSONL file path
...
output_file_path = '/local/upb/users/u/uqudus/profiles/unix/cs/jaccord/VeracityCalculation/data/output_triples_IRIs_with_v_scores2.jsonl'    # Replace with the desired output JSONL file path
